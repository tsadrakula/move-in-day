...
interface LivingRoomSceneProps {
  targetDate?: Date; // Optional, no longer used internally
}
...
export function LivingRoomScene({ targetDate }: LivingRoomSceneProps) {
  return (
    <div className="relative w-full max-w-5xl mx-auto">
      {/* Wall background */}
      <div
        className="relative rounded-lg p-4 md:p-8 shadow-inner min-h-[400px] md:min-h-[500px]"
        style={{
      ...
      >
        ...
        {/* Window on left - hidden on mobile */}
        <div className="absolute top-8 left-6 w-28 h-36 bg-sky-100 rounded border-[10px] border-amber-800 shadow-lg hidden lg:block">
        ...
        <div className="hidden md:flex flex-col items-center justify-center pt-4 relative z-10">
          {/* Top row polaroids - spread wide */}
          <div className="w-full flex justify-between items-start px-4 lg:px-24 mb-6">
          ...
          {/* Bottom row polaroids - spread wide */}
          <div className="w-full flex justify-between items-start px-8 lg:px-32 mt-10">
            <div className="transform translate-y-2">
        ...
        {/* Mobile layout - Fireplace and photos only */}
