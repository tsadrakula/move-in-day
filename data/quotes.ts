...
export const quotes: Quote[] = [
  ...
  { text: "I'm so glad we're not just friends.", category: 'engagement' },
  ...
  { text: "Plexy and actually chill.", category: 'playful' },
  ...
  { text: "Relationship status: roommates.", category: 'playful' },
  { text: "Love you more than life itself.", category: 'playful' },
  ...
  { text: "Our love story: Started with Just Friends, ended with forever.", category: 'playful' },
